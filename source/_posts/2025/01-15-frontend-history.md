...
2023 年，情况发生了些许转变。首先是 ChatGPT 的爆火导致 AI 编程的出现，许多前端程序员担心会因此丢掉饭碗。尽管这实际上是天方夜谭，但 AI 的出现确实促使各大公司纷纷开始将资源倾斜到大语言模型的训练上。或因此，前端领域在 2023 年很少有真正意义上的技术革新，大家都只是在对各自的框架和工具进行版本迭代和层层加码。这种低迷的氛围一直持续到 2024，开始有人放出“前端已死”的消极信号……
